...
hs = list(range(48))
workbook = openpyxl.load_workbook('/home/pi/SC48_Check/coefficient.xlsx')
...
fr1 = open("/home/pi/SC48_Check/coordinates.txt","r")
x1 = int(fr1.readline())
y1 = int(fr1.readline())
x2 = int(fr1.readline())
y2 = int(fr1.readline())
...
def process_image(image_name, start_point=(x1,y1), end_point=(x2,y2)):
    ...
    contours1_h1 = sorted(contours1_h1, key=lambda data:sorting_x(data))
    contours1_h2 = sorted(contours1_h2, key=lambda data:sorting_x(data))
    contours1_h3 = sorted(contours1_h3, key=lambda data:sorting_x(data))
    contours1_h4 = sorted(contours1_h4, key=lambda data:sorting_x(data))
    contours1_h5 = sorted(contours1_h5, key=lambda data:sorting_x(data))
    contours1_h6 = sorted(contours1_h6, key=lambda data:sorting_x(data))
    contours1_h7 = sorted(contours1_h7, key=lambda data:sorting_x(data))
    contours1_h8 = sorted(contours1_h8, key=lambda data:sorting_x(data))
